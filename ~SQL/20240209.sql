...
--
-- Table structure for table `ac_comment`
--
...
CREATE TABLE `ac_comment` (
  ...
  `comment_content` varchar(600) DEFAULT NULL,
  ...
  KEY `id_post` (`post_id`),
  KEY `id_user` (`user_id`),
  CONSTRAINT `id_post` FOREIGN KEY (`post_id`) REFERENCES `ac_post` (`id_post`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `id_user` FOREIGN KEY (`user_id`) REFERENCES `ac_user` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ac_comment`
--

LOCK TABLES `ac_comment` WRITE;
/*!40000 ALTER TABLE `ac_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `ac_comment` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `ac_user` VALUES (1,'asd','$2b$13$WikmiAM./uPnR1CJi/GHS.1Kb2bsMhKPeqv5c/o9vjmhDGMNdLUB2','http://localhost:3030/static/def.jpg','2024-01-11 06:45:10','2024-01-11 06:45:10','asd',NULL),(2,'asd','$2b$13$cKkpqj4wX5AgP5httSNr7uWoBDzD1dg17hIAUNFmVKA2Hjj.If0bG','/upload/avatar/defAvatar.jpg','2024-01-15 07:03:38','2024-01-15 07:03:38',NULL,NULL),(3,'asd1','$2b$13$0QCME.jxsOsAODJqBhPTBOSGbc5/ayTFUU55KNjlZ0uJAi4ho06sO','http://localhost:3030/static/def.jpg','2024-01-15 11:04:20','2024-01-15 11:04:20',NULL,NULL),(4,'asdf','$2b$13$8hoWciGTSmtbf.TWndlOa.gbuSHI/8TjVwN.9omria8HC0ZaM6Dla','http://localhost:3030/static/def.jpg','2024-01-16 07:25:54','2024-01-16 07:25:54',NULL,NULL),(5,'asda','$2b$13$uSJATNyXiN.lgPYtH/.R6.SBaH7hZc07Y0boZ8w7kyKgA4NnS.unu','http://localhost:3030/static/def.jpg','2024-01-21 10:22:59','2024-01-21 10:22:59',NULL,NULL),(6,'IndexNull','$2b$13$AsoFi9M5TgSgUEIyLtZmUu3mVRLXOF.bBUvmwu/UoGY/dPy6vFiJu','http://localhost:3030/static/userpf/44d11d5c01__hatsune_miku_sirfetch_d_and_fighting_miku_pokemon_and_2_more_drawn_by_land_k__sample-64fc047523dfe08b08a7e78eb5f8e507.jpg','2024-02-05 08:18:11','2024-02-09 04:00:26',NULL,'hello bio from frontend 2');
...
-- Dump completed on 2024-02-09 11:30:27
